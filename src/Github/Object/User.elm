...
type alias GistsOptionalArguments =
    { privacy : OptionalArgument Github.Enum.GistPrivacy.GistPrivacy, orderBy : OptionalArgument Github.InputObject.GistOrder, after : OptionalArgument String, before : OptionalArgument String, first : OptionalArgument Int, last : OptionalArgument Int }
...
type alias StarredRepositoriesOptionalArguments =
    { ownedByViewer : OptionalArgument Bool, orderBy : OptionalArgument Github.InputObject.StarOrder, after : OptionalArgument String, before : OptionalArgument String, first : OptionalArgument Int, last : OptionalArgument Int }
