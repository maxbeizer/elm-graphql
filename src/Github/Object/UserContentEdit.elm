...
deletedAt =
    Object.fieldDecoder "deletedAt" [] (Decode.oneOf [ Decode.string, Decode.float |> Decode.map toString, Decode.int |> Decode.map toString, Decode.bool |> Decode.map toString ] |> Decode.map Github.Scalar.DateTime |> Decode.nullable)
...
deletedBy object =
    Object.selectionField "deletedBy" [] object (identity >> Decode.nullable)
...
editedAt =
    Object.fieldDecoder "editedAt" [] (Decode.oneOf [ Decode.string, Decode.float |> Decode.map toString, Decode.int |> Decode.map toString, Decode.bool |> Decode.map toString ] |> Decode.map Github.Scalar.DateTime)
