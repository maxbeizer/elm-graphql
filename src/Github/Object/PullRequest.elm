...
-}
includesCreatedEdit : Field Bool Github.Object.PullRequest
includesCreatedEdit =
...
-}
maintainerCanModify : Field Bool Github.Object.PullRequest
maintainerCanModify =
    Object.fieldDecoder "maintainerCanModify" [] Decode.bool
...
-}
mergedBy : SelectionSet decodesTo Github.Interface.Actor -> Field (Maybe decodesTo) Github.Object.PullRequest
mergedBy object =
    Object.selectionField "mergedBy" [] object (identity >> Decode.nullable)
...
-}
permalink : Field Github.Scalar.Uri Github.Object.PullRequest
permalink =
    Object.fieldDecoder "permalink" [] (Decode.oneOf [ Decode.string, Decode.float |> Decode.map toString, Decode.int |> Decode.map toString, Decode.bool |> Decode.map toString ] |> Decode.map Github.Scalar.Uri)
...
type alias ReviewsOptionalArguments =
    { after : OptionalArgument String, before : OptionalArgument String, first : OptionalArgument Int, last : OptionalArgument Int, states : OptionalArgument (List Github.Enum.PullRequestReviewState.PullRequestReviewState), author : OptionalArgument String }
...
type alias TimelineOptionalArguments =
    { since : OptionalArgument Github.Scalar.DateTime, after : OptionalArgument String, before : OptionalArgument String, first : OptionalArgument Int, last : OptionalArgument Int }
...
-}
viewerCanApplySuggestion : Field Bool Github.Object.PullRequest
viewerCanApplySuggestion =
    Object.fieldDecoder "viewerCanApplySuggestion" [] Decode.bool
...
-}
viewerSubscription : Field (Maybe Github.Enum.SubscriptionState.SubscriptionState) Github.Object.PullRequest
viewerSubscription =
